...
t2 = Task.create(:title => 'Get bread', :description => 'No bread at home', :duedate => '1/9/2011', :address => '633 Bourke St Surrey Hills')
t3 = Task.create(:title => 'Get laundry', :description => 'Dirty clothes!', :duedate => '5/2/2014', :address => '111 Sussex St Syndey')
